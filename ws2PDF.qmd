...
2.  Combining dataframes and tibbles
3.  Indexing 
4.  Figures with `ggplot2` (5 min)
      + Combining plots
...
PDFs in [Quarto](https://quarto.org/docs/output-formats/pdf-basics.html) and [Rmarkdown](https://bookdown.org/yihui/rmarkdown/pdf-document.html). You will need to download some form of LaTex to write the PDFs. R recommends the following code
